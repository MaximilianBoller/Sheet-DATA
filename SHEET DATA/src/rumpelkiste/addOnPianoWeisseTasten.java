...
public class addOnPianoWeisseTasten extends JPanel
{
	public addOnPianoWeisseTasten(String Name, String note)
	{
		...
		URL weiﬂeTasteimage = this.getClass().getResource("UIWeiﬂ6.png");
