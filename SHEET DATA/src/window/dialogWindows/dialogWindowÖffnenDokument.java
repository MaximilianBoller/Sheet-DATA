...
public class dialogWindowÖffnenDokument extends JFrame 
{
	...
	public dialogWindowÖffnenDokument()
	{
		...
		URL backgroundimage = this.getClass().getResource("ÖffnenIcon.png");
...
//		links.setBackground(Color.green);
		...
		JButton öffnen = new JButton("Öffnen");
		...
		öffnen.addMouseListener(new MouseAdapter()
	    {
	        public void mouseClicked(MouseEvent e)
	        {
				...
				try {
					ÖffnenDokument.öffnen(Var.projectName);
